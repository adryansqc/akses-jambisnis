    ...
    public function run(): void
    {
        ...
        $settingItems = [
            ...
            [
                ...
                'helper_text' => 'Paket liputan & publikasi berita',
            ],
            [
                'setting_id'  => $settings['layanan']->id,
                'name'        => 'Harga Agency',
                'key'         => 'ha',
                'type'        => 'url',
                'value'       => 'https://drive.google.com/file/d/1tRhOnaWmLmG-srTk44yVztAubVUgMfcP/view?usp=drive_link',
                'helper_text' => 'Paket khusus untuk agency & korporat',
            ],
            [
                'setting_id'  => $settings['layanan']->id,
